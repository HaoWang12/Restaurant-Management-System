...
public class AltStaffActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alt_staff);
        initBar();
            ...
            case R.id.bt_register:
                ...
                if (username.equals("") || password.equals("") || again.equals("") || name.equals("")) {
                    ...
                    if (!password.equals(again)) {
                        ...
                        altUser(username, password,name,"staff");
                    }
                }
                break;
        ...
        OkHttpUtil.altUser(account, password,name,statue, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(AltStaffActivity.this, "The network is abnormal. Please try again!", Toast.LENGTH_SHORT).show();
                    }
                });
            }
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (responseData.equals("true")) {
                            Toast.makeText(AltStaffActivity.this, "Alt succeeded", Toast.LENGTH_SHORT).show();
                            finish();
                        } else {
                            Toast.makeText(AltStaffActivity.this, "Alt failed", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
