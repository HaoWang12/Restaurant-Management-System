...
public class AdminAltDishActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_alt_dish);
        initBar();
        initView();
    }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.tv_right:
                ...
                altDish(id,name,price,types,note,newprice);
                break;
        }
    }

    private void altDish(String id,String name, String price, String types, String note,String newprice) {
        OkHttpUtil.altDish(id,name,price,types,note,newprice, new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(AdminAltDishActivity.this, "The network is abnormal, please try again!", Toast.LENGTH_SHORT).show();
                    }
                });
            }
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (responseData.equals("true")) {
                            Toast.makeText(AdminAltDishActivity.this,"Submitted successfully", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(AdminAltDishActivity.this,"Submission failed", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
