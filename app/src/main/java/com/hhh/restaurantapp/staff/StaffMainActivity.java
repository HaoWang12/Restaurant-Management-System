...
import com.hhh.restaurantapp.admin.AdminFindDishActivity;
import com.hhh.restaurantapp.admin.FindCustomerActivity;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.ll01:
                ...
                break;
            case R.id.ll03:
                Intent intent2 = new Intent(StaffMainActivity.this, AdminFindDishActivity.class);
            ...
            case R.id.ll02:
                ...
                break;
            case R.id.ll04:
                Intent intent4 = new Intent(StaffMainActivity.this, FindPurchaseActivity.class);
