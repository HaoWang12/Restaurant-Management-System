    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.tv_right:
                ...
                addPurchase(content,money,time,note);
                break;
        }
    }

    private void addPurchase(String content, String money, String time, String note) {
        OkHttpUtil.addPurchase(content,money,time,note, new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(AddPurchaseActivity.this, "The network is abnormal, please try again!", Toast.LENGTH_SHORT).show();
                    }
                });
            }
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (responseData.equals("true")) {
                            Toast.makeText(AddPurchaseActivity.this,"Submitted successfully", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(AddPurchaseActivity.this,"Submission failed", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
