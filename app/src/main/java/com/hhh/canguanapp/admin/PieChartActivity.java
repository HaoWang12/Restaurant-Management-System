...
import com.hhh.canguanapp.staff.FindCaiGouActivity;
...
public class PieChartActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private LinearLayout llFenlei, llFenlei2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initBar();
        llFenlei = findViewById(R.id.ll_fenlei);
        llFenlei2 = findViewById(R.id.ll_fenlei2);
    ...
    private void setPieChartType() {
        ...
        llFenlei.removeAllViews();
        llFenlei2.removeAllViews();
        for (int i = 0; i < titleData.size(); i++) {
            ...
            if (i <= 3) {
                llFenlei.addView(view);
            } else {
                llFenlei2.addView(view);
            }
        }
